use crate::domain::services::journalism::comments::fetch_many_comments_service::FetchManyCommentsService;
...
pub fn exec(
    db_conn: &SeaService,
) -> FetchManyCommentsService<SeaArticleCommentRepository<'_>, SeaUserRepository<'_>> {
