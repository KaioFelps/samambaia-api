use crate::domain::services::security::fetch_many_comment_reports_service::FetchManyCommentReportsService;
...
pub fn exec(
    db_conn: &SeaService,
) -> FetchManyCommentReportsService<SeaCommentReportRepository<'_>, SeaUserRepository<'_>> {
