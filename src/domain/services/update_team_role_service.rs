...
mod test {
    ...
    async fn test() {
        ...
        let team_role = TeamRole::new("Ceo".into(), "Responsável por gerenciar todo o fã-site.".into());
        ...
        let result = sut.exec(UpdateTeamRoleParams {
        ...
        assert_eq!(result.description(), "Responsável por gerenciar todo o fã-site.".to_string());
