...
export function RawPublicLayout({ children }: PublicLayoutProps) {
  return (
    <>
      <Head>
        {/* Canonical link */}
        <link rel="canonical" href={appConfig.meta.appURL} />
        ...
        <meta property="og:url" content={appConfig.meta.appURL} />

        <meta property="og:image" content={appConfig.meta.cover} />

        <meta property="og:site_name" content={appConfig.meta.title} />
