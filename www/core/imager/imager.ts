...
import type { ImagerProvider } from "./providers";
...
export class Imager {
  public constructor(private provider: ImagerProvider) {}

  public async getUserImage(nickname: string, params: Partial<ImagerParamsArguments> = {}) {
    const baseUrl = await this.provider.prepareUserBaseImage(nickname);
